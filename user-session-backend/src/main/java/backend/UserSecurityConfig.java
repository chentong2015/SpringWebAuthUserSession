...
import backend.authentication.AuthenticationTokenFilter;
import backend.auth_handler.AuthenticationEntryPointHandler;
import backend.auth_handler.AuthenticationFailureHandler;
import backend.auth_handler.AuthenticationSuccessHandler;
import backend.auth_handler.MyLogoutSuccessHandler;
import backend.service.PersistenceUserDetailsService;
...
public class UserSecurityConfig {
    ...
    @Autowired
    private AuthenticationTokenFilter tokenAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors(AbstractHttpConfigurer::disable)
                ...
                .exceptionHandling(exceptionHandler -> exceptionHandler.authenticationEntryPoint(authEntryPointHandler) )
